...
@Slf4j
@Component
public class SendMessageModifiedManuscriptNotificationStrategy extends AbstractSendMessageNotificationStrategy {

    public SendMessageModifiedManuscriptNotificationStrategy(AmqpService amqpService, ObjectMapper objectMapper) {
        super(amqpService, objectMapper);
    }

    @Override
    public void send(NotificationSentEvent event) {
        ModifiedManuscriptNotificationEvent notificationEvent = (ModifiedManuscriptNotificationEvent) event;
    ...
    public boolean support(Class<? extends NotificationSentEvent> eventClass) {
        return eventClass == ModifiedManuscriptNotificationEvent.class;
    }
}
